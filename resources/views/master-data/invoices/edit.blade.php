...
@section('content')
    ...
    @endif
    <form class="form" method="post" action="{{route('invoices.update' , ['id'=>$salesinvoice->id])}}" >
        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="input-group col-md-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">Edit Invoice No {{$salesinvoice->id}}</div>
                                <div class="panel-body">
                                    <label class="col-md-2">Invoice No </label>
                                    <div class="input-group col-md-8">
                                        <input type="text" class="form-control" name="id" placeholder = "Invoice No" value="{{$salesinvoice->id}}" disabled>
                                    </div>
                                    <br/>

                                    <label class="col-md-2"> Customer </label>
                                    <div class="input-group col-md-8">
                                        <select class="form-control customer_id" data-live-search="true" required>
                                            @forelse($customers as $customer)
                                                <option value="{{$customer->id}}" {{($customer->id == $salesinvoice->customer_id) ? 'Selected' : ''}}>{{$customer->name}}</option>
                                                @empty
                                                <option Selected>No Customer Found</option>
                                            @endforelse
                                        </select>    
                                    </div>
                                    <br/>
                                    ...
                                    <div class="input-group col-md-8">
                                        <input type="date" class="form-control" name="Sales_date" placeholder = "Invoice Date" value="{{$salesinvoice->Sales_date}}" required>
                                    </div>
                                    <br/>
                                    ...
                                    <label class="col-md-2">Invoice Tax %</label>
                                    <div class="input-group col-md-8">
                                        <input type="number" class="form-control price tax" name="tax" placeholder = "Invoice Tax" value="{{$salesinvoice->tax}}" required>
                                    </div>
                                    <br/>

                                    <label class="col-md-2">Invoice Discount</label>
                                    <div class="input-group col-md-8">
                                        <input type="number" class="form-control invoice_discount price" name="dis_value" placeholder = "Invoice Discount" value="{{$salesinvoice->dis_value}}" required>
                                    </div>
                                    <br/>

                                    <label class="col-md-2">Invoice Net Price</label>
                                    <div class="input-group col-md-8">
                                        <input type="number" class="form-control net_price" name="net_price" placeholder = "Invoice Net Price" value="{{$salesinvoice->net_price}}" disabled required>
                                    </div>
                                    <br/>
                                      ...
                                      <div class="row">
                                        <table class="table table-bordered table-responsive">
                                            ...
                                            <tbody id="invoice_body">
                                                ...
                                                @php
                                                $count = $salesinvoice->sales_invoice_details->count();
                                                @endphp
                                                @if($salesinvoice->sales_invoice_details->count()== 0)
                                                    
                                                <tr id="clone0">
                                                    <td></td>
                                                    <td class="counter" width="2%"></td>
                                                    <td width="10%">
                                                        <Select name="inv_detail[0][category_id]" class="form-control selectpicker category_id" data-live-search="true" required>
                                                            <option value=""> Select Category </option>
                                                            @forelse($categories as $category)
                                                                <option value="{{$category->id}}">{{$category->name}}</option>
                                                            @empty
                                                    ...
                                                    <td width="10%">
                                                        <Select name="inv_detail[0][item_id]" class="form-control selectpicker item_id" data-live-search="true" required>
                                                            <option value=""> Select Item </option>
                                                            @forelse ($items as $item)
                                                                <option value="{{$item->id}}">{{$item->name}}</option>
                                                            @empty
                                                    ...
                                                    <td width="8%">
                                                        <input type="number" class="form-control sell_price price"  name="inv_detail[0][sell_price]"  placeholder=" Sell Price " step="any" value="0" >
                                                    </td>

                                                    <td width="8%">
                                                        <input type="hidden" class="form-control size_id" name="inv_detail[0][size_id]">
                                                        <input type="text" class="form-control size"  name="inv_detail[0][size]"  placeholder=" Size " readonly >
                                                    </td>

                                                    <td width="8%">
                                                        <input type="hidden" class="form-control color_id" name="inv_detail[0][color_id]">
                                                        <input type="text" class="form-control color"  name="inv_detail[0][color]" placeholder="Color " readonly >
                                                    </td>

                                                    <td width="10%">
                                                        <Select name="inv_detail[0][offer_id]" class="form-control selectpicker offer_id" data-live-search="true" >
                                                            <option value=""> --- Select Offer --- </option>
                                                        </Select>
                                                    </td>

                                                    <td width="8%">
                                                        <input type="number" class="form-control offer_discount " step="any" name="inv_detail[0][offer_discount]"  placeholder="Offer Discount " readonly>
                                                    </td>


                                                    <td width="8%">
                                                        <input type="number" class="form-control qty price" value="1" step="any" name="inv_detail[0][qty]"  placeholder="Enter Quantity " >
                                                    </td>


                                                    <td width="8%">
                                                        <input type="number" class="form-control other_discount price" value="0" step="any" name="inv_detail[0][other_discount]"  placeholder="Other Discount Value" >
                                                    </td>

                                                
                                                    <td width="8%">
                                                        <input type="number" class="form-control itemafterdiscount " step="any" name="inv_detail[0][itemafterdiscount]" value="0" placeholder="Item After Discount " readonly>
                                                    </td>

                                                    <td width="8%">
                                                        <input type="number" class="form-control itemnetprice " step="any" name="inv_detail[0][itemnetprice]" value="0" placeholder="Item Net Price " readonly>
                                                    </td>
                                                ...
                                                <tr id="clone{{$loop->iteration}}"> 
                                                    ...
                                                    <td width="10%">
                                                        <Select name="inv_detail[{{$loop->iteration}}][category_id]" class="form-control selectpicker category_id" data-live-search="true" required>
                                                            <option value=""> Select Category </option>
                                                            @forelse($categories as $category)
                                                                <!-- <option value="{{$category->id}}">{{$category->name}}</option> -->
                                                    ...
                                                    <td width="10%">
                                                        <Select name="inv_detail[{{$loop->iteration}}][item_id]" class="form-control item_id" data-live-search="true" required>
                                                            <option value=""> Select Item </option>
                                                            @forelse ($items as $item)
                                                    ...
                                                    <td width="8%">
                                                        <input type="number" class="form-control sell_price price"  name="inv_detail[{{$loop->iteration}}][sell_price]" value="{{$detail->item->sell_price}}" placeholder=" Sell Price " step="any" value="0" >
                                                    </td>

                                                    <td width="8%">
                                                        <input type="hidden" class="form-control size_id" name="inv_detail[{{$loop->iteration}}][size_id]" value="{{$detail->item->size_id}}">
                                                        <input type="text" class="form-control size"  name="inv_detail[{{$loop->iteration}}][size]" value="{{$detail->item->size->size_name}}" placeholder=" Size " readonly >
                                                    </td>

                                                    <td width="8%">
                                                        <input type="hidden" class="form-control color_id" name="inv_detail[{{$loop->iteration}}][color_id]" value="{{$detail->item->color_id}}">
                                                        <input type="text" class="form-control color"  name="inv_detail[{{$loop->iteration}}][color]"  value="{{$detail->item->color->color_name}}" placeholder="Color " readonly >
                                                    </td>

                                                    <td width="10%">
                                                        <Select name="inv_detail[{{$loop->iteration}}][offer_id]" class="form-control selectpicker offer_id" data-live-search="true" >
                                                            <option value=""> --- Select Offer --- </option>
                                                            @forelse ($offerheader as $oh)
                                                                <option value="{{$oh->id}}" {{($oh->id == $detail->offer_id) ? 'Selected' : ''}}>{{$oh->offername}}</option>
                                                            @empty
                                                                <option Selected>No Item Found</option>
                                                            @endforelse
                                                        </Select>
                                                    ...
                                                    <td width="8%">
                                                        ...
                                                        <input type="number" class="form-control offer_discount " step="any" name="inv_detail[{{$loop->iteration}}][offer_discount]"  value="{{$od->dis_item_value}}" placeholder="Offer Discount " readonly>
                                                        @endforeach
                                                    </td>


                                                    <td width="8%">
                                                        <input type="number" class="form-control qty price" value="{{$detail->qty}}" step="any" name="inv_detail[{{$loop->iteration}}][qty]"  placeholder="Enter Quantity " >
                                                    </td>


                                                    <td width="8%">
                                                        <input type="number" class="form-control other_discount price" value="{{$detail->other_discount}}" step="any" name="inv_detail[{{$loop->iteration}}][other_discount]"  placeholder="Other Discount Value" >
                                                    </td>

                                                
                                                    <td width="8%">
                                                        <input type="number" class="form-control itemafterdiscount " step="any" name="inv_detail[{{$loop->iteration}}][itemafterdiscount]" value="0" placeholder="Item After Discount " readonly>
                                                    </td>

                                                    <td width="8%">
                                                        <input type="number" class="form-control itemnetprice " step="any" name="inv_detail[{{$loop->iteration}}][itemnetprice]" value="{{$detail->other_discount}}" placeholder="Item Net Price " readonly>
                                                    </td>
